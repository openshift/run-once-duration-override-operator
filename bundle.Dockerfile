...
ARG OPERATOR_IMAGE=registry.redhat.io/run-once-duration-override-operator/run-once-duration-override-rhel9-operator@sha256:fb2a4cbd2e0dcb7a0879d1422ba7dc78c5b8a52f2d7f70c3fd5dfebe07d8f941
