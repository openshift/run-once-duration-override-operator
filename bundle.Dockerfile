...
ARG OPERATOR_IMAGE=registry.redhat.io/run-once-duration-override-operator/run-once-duration-override-rhel9-operator@sha256:a2352a7180c7f9a3c6fe84a89d5e7d9492e5f2367be86a395620512e4161324a
