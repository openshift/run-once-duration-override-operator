...
ARG OPERATOR_IMAGE=registry.redhat.io/run-once-duration-override-operator/run-once-duration-override-rhel9-operator@sha256:71baa22e3a59456d809948258eeed862c0521bceccfddfca81eb011ef94f1f1a
