...
ARG OPERATOR_IMAGE=registry.redhat.io/run-once-duration-override-operator/run-once-duration-override-rhel9-operator@sha256:90c9435b6378ffef4d3ebcbb7aa3a64d4c33db543cd9182ee8ea6487ef03c297
