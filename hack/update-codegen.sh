...
# 1. copy paste pkg/apis/runoncedurationoverride/v1/override_types.go under github.com/openshift/api/ under operator/v1 directory (and update the file to remove the cyclic dependency)
...
kube::codegen::gen_client \
    ...
    --output-pkg "github.com/openshift/run-once-duration-override-operator/pkg/generated" \
