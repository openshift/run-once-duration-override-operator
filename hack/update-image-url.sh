...
sed "s,RUNONCEDURATIONEOVERRIDE_OPERATOR_REGISTRY_IMAGE,${REGISTRY_IMAGE},g" -i "${FILE_TO_CHANGE}"
sed "s,RUNONCEDURATIONEOVERRIDE_OPERATOR_IMAGE,${OPERATOR_IMAGE},g" -i "${FILE_TO_CHANGE}"
sed "s,RUNONCEDURATIONEOVERRIDE_OPERAND_IMAGE,${OPERAND_IMAGE},g" -i "${FILE_TO_CHANGE}"
