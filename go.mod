...
require (
	...
	google.golang.org/protobuf v1.35.2 // indirect; to improve error handling
	k8s.io/api v0.27.6
...
replace (
	...
	k8s.io/apimachinery => k8s.io/kubernetes/staging/src/k8s.io/apimachinery v0.0.0-20250302131855-c5b83f7c6c3b
