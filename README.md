...
$ opm alpha convert-template basic -o yaml ./catalog-migrate/run-once-duration-override-operator/catalog.json > v4.16/catalog-template.yaml
```

To update the catalog

```
$ opm alpha render-template basic v4.16/catalog-template.yaml > v4.16/catalog/run-once-duration-override-operator/catalog.json
```
