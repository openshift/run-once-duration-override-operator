...
$ opm alpha convert-template basic -o yaml ./catalog-migrate/run-once-duration-override-operator/catalog.json > v4.19/catalog-template.yaml
```
...
$ opm alpha render-template basic v4.19/catalog-template.yaml --migrate-level bundle-object-to-csv-metadata > v4.19/catalog/run-once-duration-override-operator/catalog.json
```
