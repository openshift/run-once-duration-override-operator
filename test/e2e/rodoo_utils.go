...
// buildRunOnceDurationOverride creates a RunOnceDurationOverride CR with base configuration
// and allows customization via a modifier function.
func buildRunOnceDurationOverride(modify func(*rodoov1.RunOnceDurationOverride)) *rodoov1.RunOnceDurationOverride {
...
func createRunOnceDurationOverride(ctx context.Context, rodooClient *rodooclient.Clientset, activeDeadlineSeconds int64) error {
	...
	cr := buildRunOnceDurationOverride(func(r *rodoov1.RunOnceDurationOverride) {
		r.Spec.RunOnceDurationOverrideConfig = rodoov1.RunOnceDurationOverrideConfig{
